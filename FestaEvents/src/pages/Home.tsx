        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            <motion.div variants={scaleIn} className="bento-card col-span-2 bg-charcoal text-white border-[3px] border-charcoal">
              ...
              <p className="font-display text-5xl font-black">1050+</p>
            ...
            <motion.div variants={scaleIn} className="bento-card bg-accent-sage text-charcoal border-[3px] border-charcoal">
              ...
              <p className="font-display text-3xl font-black">4.9</p>
            ...
            <motion.div variants={scaleIn} className="bento-card col-span-2 bg-accent-rose text-charcoal border-[3px] border-charcoal overflow-hidden relative">
              <div className="relative z-10 flex items-center justify-between">
                <div>
                  ...
                  <p className="font-display text-xl font-bold mt-1">Bengaluru</p>
                </div>
                <MapPin className="w-8 h-8 text-gold" />
              </div>
              <p className="relative z-10 text-charcoal/70 text-sm mt-2">Serving across India & beyond</p>
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
        ...
        >
          <motion.div variants={fadeInUp} className="lg:col-span-5 bento-card bg-charcoal text-white border-[3px] border-charcoal flex flex-col justify-between min-h-[400px]">
            ...
            <p className="text-white/70 text-lg leading-relaxed mt-8">
              Born from a passion for celebration, Festa transforms ordinary moments into extraordinary memories. Every event is a masterpiece of creativity, precision, and heart.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-7 grid grid-cols-2 gap-6">
            <div className="bento-card bg-accent-sage text-charcoal border-[3px] border-charcoal flex flex-col justify-between">
              ...
              <div>
                <p className="font-display text-3xl sm:text-4xl font-black">5+</p>
            ...
            <div className="bento-card bg-accent-lavender text-charcoal border-[3px] border-charcoal flex flex-col justify-between">
              ...
              <div>
                <p className="font-display text-3xl sm:text-4xl font-black">1050+</p>
    ...
    <section className="py-24 px-6 lg:px-12 bg-ivory">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-4xl lg:text-6xl font-bold mt-4">
            Why <span className="italic text-gold">Festa</span>
          </h2>
        </motion.div>
    ...
    <section className="py-28 px-6 lg:px-12 bg-charcoal relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <AnimatedStat end={4.9} suffix="" decimals={1} label="Client Rating" />
          <AnimatedStat end={100} suffix="%" decimals={0} label="Client Focus" />
        </div>
      </div>
    </section>
  );
...
function Testimonials() {
  ...
  const testimonials = [
    { name: 'Priya & Rahul', event: 'Wedding', text: 'Festa made our dream wedding a reality. Every detail was perfect, from the floral arrangements to the catering. Our guests are still talking about it!', rating: 5 },
    ...
    { name: 'TechVista Corp', event: 'Corporate', text: 'Professional, creative, and incredibly organized. Our annual gala was the best one yet thanks to Festa\'s meticulous planning.', rating: 5 },
    { name: 'Meera & Karthik', event: 'Reception', text: 'We trusted Festa with our reception and they exceeded every expectation. The venue transformation was breathtaking.', rating: 5 },
    ...
    { name: 'Rajesh Kumar', event: 'House Warming', text: 'Festa turned our house warming into a memorable celebration. The decor was elegant and the coordination was flawless.', rating: 5 },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <span className="text-warm-gray">4.9 average from 330+ Google Reviews</span>
          </div>
        </motion.div>
