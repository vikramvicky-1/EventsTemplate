      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
            ...
            {/* Desktop Nav Links with staggered slide-down animation */}
            ...
            >
                      ...
                      <Link
                        ...
                        className={`flex items-center justify-between py-3 px-3 rounded-lg text-[0.95rem] font-display font-semibold transition-all duration-200 ${
                          location.pathname === link.path
                            ...
                            : 'text-text-primary hover:text-gold hover:bg-black/[0.02]'
                        }`}
                      >
                        {link.name}
                        {location.pathname === link.path && (
              ...
              >
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-semibold text-text-primary group-hover:text-gold transition-colors">@eventsbybutterflies</p>
                    <p className="text-[0.65rem] text-gold font-medium">Event Planner</p>
                  </div>
                </a>
