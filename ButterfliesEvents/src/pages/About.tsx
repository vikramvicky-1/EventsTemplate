...
const team = [
  { name: 'Team Lead', role: 'Founder & Creative Director', image: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=400' },
  { name: 'Design Head', role: 'Head of Decor & Design', image: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=400' },
  { name: 'Operations Lead', role: 'Operations Manager', image: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=400' },
  { name: 'Client Relations', role: 'Client Relations Head', image: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=400' },
];
...
const achievements = [
  ...
  { value: '5+', label: 'Years' },
  { value: '1034', label: 'Google Reviews' },
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <p className="text-text-secondary text-lg mt-6 max-w-2xl">
              Butterflies Event Management was born from a simple belief: every celebration deserves to be extraordinary. We blend creativity, precision, and passion to craft events that become cherished memories.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="lg:col-span-7 luxury-card bg-bg-secondary min-h-[400px] flex flex-col justify-between">
              <div>
                <span className="text-gold text-xs font-medium tracking-[0.2em] uppercase">Your Trusted Event Partner</span>
                <h2 className="font-display text-4xl font-bold mt-4 text-text-primary">
                  From a Dream<br />to a Movement
                </h2>
              </div>
              <p className="text-text-secondary text-lg leading-relaxed">
                What started as a passion project in Bengaluru has grown into one of the most loved event planners in the city. With a 4.9-star Google rating and over 1,034 reviews, we've had the privilege of designing over 1000 celebrations, each one unique, each one unforgettable. Open 24 hours, we're always ready to bring your dreams to life.
              </p>
            </motion.div>
