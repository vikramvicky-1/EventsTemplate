...
const services = [
  ...
  { icon: Cake, name: 'Birthday Celebrations', desc: 'Milestone moments deserve extraordinary celebrations. We create themed birthday parties that delight guests of all ages with custom balloon decorations and more.', features: ['Theme Design', 'Balloon Decorations', 'Custom Cakes', 'Caricature Artists', 'Photography'], image: '/images/birthday_decor.png' },
  ...
  { icon: Palette, name: 'Balloon Decorations', desc: 'Transform any space with stunning balloon art and arrangements. From themed arches to custom balloon walls, we create visual spectacles.', features: ['Balloon Arches', 'Balloon Walls', 'Theme Matching', 'Custom Designs', 'Event Styling'], image: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&q=80&w=800' },
  ...
  { icon: Music, name: 'Entertainment', desc: 'From live bands to DJs, from dancers to caricature artists — we curate entertainment that keeps your guests engaged and having fun.', features: ['DJ Services', 'Live Bands', 'Dance Performances', 'Caricature Artists', 'Sound & Lighting'], image: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&q=80&w=800' },
  { icon: UtensilsCrossed, name: 'Catering', desc: 'Culinary experiences that delight the palate. Quality Veg and Non-Veg food with live counters that impress every guest.', features: ['Multi-cuisine Menus', 'Live Counters', 'Custom Cakes', 'Veg & Non-Veg Options', 'Dietary Accommodations'], image: '/images/catering_decor.png' },
  { icon: MapPinned, name: 'Venue Booking', desc: 'Find the perfect location for your event. We have partnerships with premium venues across Bengaluru and beyond.', features: ['Venue Scouting', 'Negotiation', 'Site Visits', 'Contract Review', 'Layout Planning'], image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=800' },
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <p className="text-text-secondary text-lg mt-6 max-w-2xl">
              From concept to celebration, we offer comprehensive event planning services that cover every aspect of your special occasion. Decoration, catering, photography, entertainment and more!
            </p>
          </motion.div>
        </div>
      </section>
