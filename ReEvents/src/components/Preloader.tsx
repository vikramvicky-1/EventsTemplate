      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-12 h-12 bg-[#121212] rounded-full pointer-events-none"
          />

          {/* Circle 2: Bronze Gold */}
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 80 }}
            transition={{ 
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            {/* Linear Brand Gold Progress Bar */}
