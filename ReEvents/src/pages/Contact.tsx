            ...
            >
              <motion.div variants={fadeInUp} className="bento-card bg-charcoal text-white border-[3px] border-charcoal">
                ...
                <div className="space-y-5">
                  <a href="tel:+917676789839" className="flex items-center gap-4 hover:text-gold transition-colors">
                    <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                      <Phone className="w-5 h-5 text-gold" />
                    </div>
                    <div>
                      <p className="text-white/60 text-xs font-semibold">Call Us</p>
                      <p className="font-bold">+91 76767 89839</p>
                    </div>
                  </a>
                  <a href="mailto:hello@reevents.com" className="flex items-center gap-4 hover:text-gold transition-colors">
                    <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                      <Mail className="w-5 h-5 text-gold" />
                    </div>
                    <div>
                      <p className="text-white/60 text-xs font-semibold">Email</p>
                      <p className="font-bold">hello@reevents.com</p>
                    </div>
                  </a>
                  <a href="https://wa.me/917676789839" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:text-gold transition-colors">
                    <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                  ...
                  <a href="https://www.instagram.com/royaleraevents/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:text-gold transition-colors">
                    <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                      <Instagram className="w-5 h-5 text-gold" />
                    </div>
                    <div>
                      <p className="text-white/60 text-xs font-semibold">Instagram (114K Followers)</p>
                      <p className="font-bold">@royaleraevents</p>
                    </div>
                  </a>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-sm">105, Vasanthapura Main Rd, Bikasipura, Bengaluru</p>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          >
            <div className="aspect-[21/9] bg-ivory flex items-center justify-center relative">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="font-display text-2xl font-semibold">Bikasipura, Bengaluru</p>
                <p className="text-warm-gray mt-2">105, Vasanthapura Main Rd, opp. SBI Bank, Banashankari 5th Stage</p>
              </div>
            </div>
          </motion.div>
        </div>
