...
const reviews = [
  {
    ...
    event: 'Wedding',
    date: 'December 2024',
    text: 'Royal Era Events made our dream wedding a reality. Every single detail was perfect — from the breathtaking floral arrangements to the seamless coordination on the day. Our guests are still talking about how beautiful everything was. The team went above and beyond our expectations.',
    rating: 5,
  },
  {
    name: 'Ananya Sharma',
  ...
  },
  {
    ...
    date: 'October 2024',
    text: 'Professional, creative, and incredibly organized. Our annual gala was the best one yet thanks to Royal Era Events. They handled 500+ guests seamlessly and the AV setup was flawless. Already booked them for next year.',
    rating: 5,
  },
  {
    name: 'Meera & Karthik',
    event: 'Reception',
    date: 'September 2024',
    text: 'We trusted Royal Era Events with our reception and they exceeded every expectation. The venue transformation was absolutely breathtaking. The lighting, the stage design, the food — everything was world-class.',
    rating: 5,
  },
  {
    name: 'Sneha Patel',
    event: 'Baby Shower',
    date: 'August 2024',
    text: 'The most beautiful baby shower I could have imagined. The pastel theme, the personalized games, the food — absolutely perfect. Royal Era Events understood exactly what I wanted and delivered beyond my dreams.',
    rating: 5,
  },
  {
    name: 'Rajesh & Family',
    event: 'House Warming',
    date: 'July 2024',
    text: "Royal Era Events turned our house warming into a truly memorable celebration. The decor was elegant and sophisticated, the coordination was flawless, and they managed everything so we could enjoy every moment with our guests.",
    rating: 5,
  },
  {
    name: 'Deepa Krishnan',
    event: 'Engagement',
    date: 'June 2024',
    text: 'Our engagement ceremony was everything we dreamed of and more. The ring ceremony setup was gorgeous, the photography captured every emotion perfectly. Thank you Royal Era Events for making our special day so magical!',
    rating: 5,
  },
  {
    name: 'Vikram Singh',
    ...
    date: 'May 2024',
    text: 'We hired Royal Era Events for our product launch and they delivered beyond expectations. The venue, the branding, the guest experience — everything was top-notch. Highly recommend for corporate events.',
    rating: 5,
  },
  {
    name: 'Lakshmi & Arun',
    event: 'Anniversary',
    date: 'April 2024',
    text: 'Our 25th anniversary celebration was absolutely perfect. Royal Era Events created such a warm and elegant atmosphere. The photo wall of our journey together brought tears to everyone\'s eyes. Truly unforgettable.',
    rating: 5,
  },
];
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-white/70 text-sm">4.8 out of 5</span>
                </div>
              </div>
            </div>
            <a
